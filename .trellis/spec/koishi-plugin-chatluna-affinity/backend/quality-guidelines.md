...
- 当前汇总的数据来源只允许当前 scope 的 `chatluna_affinity_v2`、`chatluna_blacklist_v2`、`chatluna_user_alias_v2`；趋势和周同比的数据来源只允许当前 scope 的 `chatluna_affinity_dashboard_snapshot`。
